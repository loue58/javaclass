...
public class RandomProteinGenerator {
	 ...
	 * 
	 */
	private static char AA_ID [] = { 'A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'Y' };
	private static float AA_NON_UNIF_FREQ [] =  {0.072658f, 0.024692f, 0.050007f, 0.061087f,
			0.041774f, 0.071589f, 0.023392f, 0.052691f, 0.063923f,
			0.089093f, 0.023150f, 0.042931f, 0.052228f, 0.039871f,
			0.052012f, 0.073087f, 0.055606f, 0.063321f, 0.012720f,
			0.032955f};
	...
	{
		float[] cumfreq = new float[aaFreq.length+1] ;
