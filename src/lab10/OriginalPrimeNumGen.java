...
// On 1 threads with 4 available processors it took 53 seconds.
// Found 54070 prime numbers in 666666

public class OriginalPrimeNumGen extends JFrame
{
	...
	private final OriginalPrimeNumGen thisFrame;
	
	public static void main(String[] args)
	{
		OriginalPrimeNumGen png = new OriginalPrimeNumGen("Primer Number Generator");
	...
	private OriginalPrimeNumGen(String title)
	{
		super(title);
		this.thisFrame = this;
	...
	private class UserInput implements Runnable
	{
		...
		public void run()
		{
			...
			System.out.println("On 1 threads with " + Runtime.getRuntime().availableProcessors() + " available processors it took " + (System.currentTimeMillis() - startTime) / 1000 + " seconds.");
			System.out.println("Found " + list.size() + " prime numbers in " + max);
			SwingUtilities.invokeLater( new Runnable()
			{
				@Override
				public void run()
